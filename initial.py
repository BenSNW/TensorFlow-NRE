...
def init():
    ...
    relation2id = {}
    f = open('origin_data/relation2id.txt', 'r', encoding='utf8')
    while True:
        content = f.readline()
        if content == '':
            break
    ...
    f = open('origin_data/train.txt', 'r', encoding='utf8')
    ...
    f = open('origin_data/test.txt', 'r', encoding='utf8')
    ...
    f = open('data/train_q&a.txt', 'w', encoding='utf8')
    temp = 0
    for i in train_sen:
    ...
    f = open('data/test_q&a.txt', 'w', encoding='utf8')
    temp = 0
    for i in test_sen:
...
def seperate():
    ...
    print('separating p-one test data')
    test_word = []
    test_pos1 = []
    test_pos2 = []
    ...
    print('separating p-two test data')
    test_word = []
    test_pos1 = []
    test_pos2 = []
    ...
    print('separating p-all test data')
    test_word = []
    test_pos1 = []
    test_pos2 = []
    ...
    print('separating test all data')
...
def getsmall():
    ...
    for i in range(len(word)):
        ...
        if length > 2000 and length < 3000:
            new_word.append(word[i][:1000])
        ...
        if length > 3000 and length < 4000:
            new_word.append(word[i][:1000])
            new_word.append(word[i][1000:2000])
...
def get_metadata():
    fwrite = open('data/metadata.tsv', 'w', encoding='utf8')
    f = open('origin_data/vec.txt', encoding='utf8')
    f.readline()
    while True:
